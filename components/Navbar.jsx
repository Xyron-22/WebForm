...
const Navbar = ({toggleNavbar, setToggleNavbar}) => {
  ...
  return (
    <div className={`w-full absolute top-0 md:w-[15%] z-[99999] md:sticky h-full md:h-[100vh] md:mt-[-7vh] overflow-auto bg-[#222b3c] md:border-r-[1px] border-lightText ${toggleNavbar ? "inline" : "hidden"} md:inline`}>
        ...
        <div className='w-full min-h-[10%] text-black flex flex-col justify-between flex-wrap bg-dark p-5'>
            <h1 className='lg:p-2 lg:pl-2 xl:pl-5 text-sm text-lightText'>ORDERS</h1>
            <Link href={"/orders/booking"} className='lg:ml-5 xl:ml-10 my-1 text-white font-semibold flex items-center'><BsTable className='mr-1'></BsTable>Bookings</Link>
            <Link href={"/records/account"} className='lg:ml-5 xl:ml-10 my-1 text-white font-semibold flex items-center'><VscAccount className='mr-1'></VscAccount>Invoice</Link>
            <Link href={"/records/product"} className='lg:ml-5 xl:ml-10 my-1 text-white font-semibold flex items-center'><BsCart4 className='mr-1'></BsCart4>Approved</Link>
        </div>
        <hr className='w-[90%] text-light m-auto'></hr>
        <div className='w-full min-h-[10%] text-black flex flex-col justify-between flex-wrap bg-dark p-5'>
